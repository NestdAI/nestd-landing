# Nestd alerts landing: oorspronkelijke specificatie

De oorspronkelijke visuele richtingen hieronder zijn vervangen door de later goedgekeurde techontwerpen. Voor actuele content, appbranding en de definitieve keuze voor uitsluitend Nestd Pro (€14,99 per maand, alle functies inbegrepen), zie [content-brand-review.md](../../content-brand-review.md) en [tech-design-review.md](../../tech-design-review.md).
...
- Product story: monitor new listings, deterministic city/budget/rooms/floor-area filters, fast alerts, user responds directly to advertiser. No AI/chat/swipe/partner promises. No fabricated reviews, user counts, coverage, timing statistics, “fastest” comparisons or availability. No automatic replies/applications. Current pricing correction: Nestd Pro is the only plan, €14.99 per month, with all active features included.
- All primary CTAs open `https://apps.apple.com/nl/app/nestd/id6761392857` directly. The old ID 6740091498 is incorrect. Native anchors must work even if JS/analytics fails. All CTA notes state the €14.99/month Pro subscription; no Google Play CTA.
